const recipes = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Cherry tomatoes", quantity: 5, unit: "" },
      { name: "A few thin slices of Red onion", quantity: "", unit: "" },
      { name: "Olive oil", quantity: 1, unit: "tsp" },
      { name: "Fresh herbs, parsley or mint", quantity: "", unit: "" },
    ],
  ...
  },
  {
    ...
    ingredients: [
      { name: "Chicken breast or thigh", quantity: 200, unit: "g" },
      { name: "Garlic", quantity: 1, unit: "clove" },
      { name: "Soy sauce", quantity: 2, unit: "tbsp" },
      { name: "Honey or maple syrup", quantity: 1, unit: "tbsp" },
      { name: "Rice vinegar or lemon juice", quantity: 1, unit: "tbsp" },
      { name: "Sesame oil or neutral oil", quantity: 1, unit: "tbsp" },
      { name: "Cooked rice", quantity: "", unit: "" },
      {
        name: "Steamed broccoli, edamame, or carrots (optional, but highly recommended)",
        quantity: "",
        unit: "",
      },
      {
        name: "Sesame seeds & green onion – for garnish (optional)",
        quantity: "",
        unit: "",
      },
    ],
